...
const DeleteItineraryItemModal = ({
  isOpen,
  onClose,
  onConfirm,
  item,
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-grow">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-bold text-slate-900">Delete Activity</h3>
              <button
                onClick={onClose}
                disabled={isLoading}
            ...
            <p className="mt-2 text-sm text-slate-600">
              Are you sure you want to remove <span className="font-semibold text-slate-900">"{item.title}"</span> from this itinerary? This action cannot be undone.
            </p>
          </div>
        </div>
...
export default DeleteItineraryItemModal;
